...
/**
 * Service class which retrieves the data requested by the REST controller makes
 * use of jdbcTemplate to retrieve the data from table EMP
 * 
...
public class EmployeeService
{
	...
	public String addEmployee(String fName, String lName)
	{
		...
		// for demo purposes hard code all the remaining fields (except first name and
		// last name)
		String midInit = "A";
		String workdept = "E21";
		String phoneNo = "1234";
